...
const Header = () => {
  ...
  return (
    <>
      ...
      <div className={toggle ? "res-menu toggle" : "res-menu"}>
          <div className="res-menu_item">Profile</div>
          <div className="res-menu_item">Post Project</div>
          <div className="res-menu_item">Search Project</div>
          <div className="res-menu_item">Saved</div>
